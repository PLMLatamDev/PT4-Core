...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/calculators/aclaramiento-de-creatinina.js"></script>
...
<div class="col-md-1"></div>
  <div class="col-md-10" id="creatininaPrincipal">
     <div class="box box-default">
                ...
                <!-- form start -->
                <form class="form-horizontal" id="aclaramientocreatinina">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Creatinina (mg/dl)*</label>
                      <div class="col-sm-2">
...
<!--                   <h3 class="box-title"><strong>Resultados</strong></h3> -->
                    <p>Resultado :&nbsp;<span id="aclaramientocreatininaresultado"> </span></p>
                    <p><span id="textaclaramientocreatinina"> </span></p>
